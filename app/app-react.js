(function(){
  ...
  class App extends React.Component{
    constructor(props){
      super(props);
      this.state={
        token:'',version:'0.11.2',view:'session',theme:lsGet('theme','dark'),connection:'booting',
    ...
    async bootstrap(){
      ...
      try{
        ...
        this.setState({token:this.token,version:String(bootstrap.version||'0.11.2')});
    ...
    renderTop(){
      ...
      return h('header',{className:'appbar'},
        h('div',{className:'brand-block'},h('div',{className:'brand-mark','aria-hidden':'true'},h('span',{className:'brand-wave'},h('i'),h('i'),h('i'),h('i'))),h('div',null,h('div',{className:'brand-line'},h('span',{className:'brand-name'},'Auralis'),h('span',{className:'brand-edition'},'Direct Audio Workspace')),h('div',{className:'brand-version'},'v0.11.2 · Runtime Auth Stabilization'))),
