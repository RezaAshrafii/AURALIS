...
export function isRuntimeCapabilityQuestion(text) {
  ...
  return /(?:صدای?\s*(?:من|سیستم)|میکروفون|لوپ\s*بک|loopback|ضبط|صوت).*(?:داری|می ?شنوی|میگیری|می ?گیری|کار می ?کنه|فعاله|وصله)|(?:می ?شنوی|شنیدی).*(?:من|صدا)/iu.test(
    t
  );
}
