...
const fixture = JSON.parse(
  await readFile(resolve(ROOT, "test-data/V014_CITATION_BENCHMARK.json"), "utf8")
);
...
const report = {
  schemaVersion: 1,
  citation,
  retrieval: { passed: retrievalPassed, topChunkId: retrieval[0]?.chunk_id || null },
};
