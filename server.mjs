...
function health() {
  ...
  return {
    product: 'Auralis',
    version: VERSION,
    releaseClass: 'RUNTIME_AUTH_STABILIZATION',
...
const server = Bun.serve({
  ...
  async fetch(req) {
    ...
    if (u.pathname === '/v1/bootstrap' && req.method === 'GET') {
      ...
      return json({ token: TOKEN, version: VERSION, schemaVersion: SCHEMA_VERSION, releaseClass: 'RUNTIME_AUTH_STABILIZATION' });
    }
    ...
    if (u.pathname === '/v1/diagnostics/export' && req.method === 'GET') {
      ...
      return json({
        ...
        audioIncluded: false,
        note: 'Diagnostics exclude secrets and raw audio. v0.11.2 preserves the engineering foundation and hardens provider authentication, runtime readiness, error recovery, and health reporting. Rust neural VAD + streaming partial/final ASR + local whisper remain pending.'
      });
    }
