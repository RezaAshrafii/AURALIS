...
const wasapi = await readFile(
  new URL("../native/core/src/audio/wasapi.rs", import.meta.url),
  "utf8"
);
const handoff = await readFile(
  new URL("../native/core/src/audio/handoff.rs", import.meta.url),
  "utf8"
);
const audioMod = await readFile(
  new URL("../native/core/src/audio/mod.rs", import.meta.url),
  "utf8"
);
...
const verifier = await readFile(
  new URL("../scripts/verify-v012-capture-summary.ps1", import.meta.url),
  "utf8"
);
const buildScript = await readFile(
  new URL("../scripts/build-v012-windows-test.ps1", import.meta.url),
  "utf8"
);
...
test("packaged v0.14 product bridge is default while hardware-only v0.13 artifacts remain gated", () => {
  ...
  assert.ok(
    block.indexOf("V014_NATIVE_CANDIDATES") <
      block.indexOf("ENABLE_EXPERIMENTAL_V013_PRODUCT_CAPTURE")
  );
