    ...
    [
      {
        ...
        document_id: "a",
        title: "آمار",
        text_raw: "واریانس و انحراف معیار دو معیار پراکندگی هستند",
        ftsRank: 3,
      },
      {
        chunk_id: "a2",
      ...
      },
      {
        ...
        document_id: "a",
        title: "آمار",
        text_raw: "انحراف معیار تعریف می‌شود",
        ftsRank: 1,
      },
      {
        chunk_id: "b1",
        document_id: "b",
        title: "پراکندگی",
        text_raw: "تفاوت واریانس و انحراف معیار به واحد اندازه‌گیری مربوط است",
        ftsRank: 4,
      },
    ],
    plan,
...
test("citation benchmark scores accepted evidence and adversarial rejection without false positives", () => {
  const report = runCitationBenchmark([
    {
      id: "valid",
      evidence: [{ chunkId: "c1", text: "این متن یک شاهد معتبر و قابل نقل است." }],
      citations: [{ chunkId: "c1", quote: "یک شاهد معتبر و قابل نقل است" }],
      expectedChunkIds: ["c1"],
    },
    {
      id: "invalid",
      evidence: [{ chunkId: "c2", text: "متن واقعی" }],
      citations: [{ chunkId: "c2", quote: "متن جعلی طولانی" }],
      expectedChunkIds: [],
    },
  ]);
...
test("v0.14 server persists intelligence, retrieval provenance, source lineage, and citation audits", () => {
  for (const table of ["turn_intelligence", "retrieval_runs", "retrieval_hits", "citation_audits"])
    assert.ok(server.includes(`CREATE TABLE IF NOT EXISTS ${table}`));
