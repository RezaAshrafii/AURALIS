...
| v0.12 Production Windows Audio Core | AUR-1201 domain/persistence, 1202 mic, 1203 loopback/dual, 1204 spool/ledger/gap, 1205 lifecycle/recovery, 1206 hardware gate | ACTIVE — AUR-1201 complete; AUR-1202 next | Real mic, loopback, dual, right-channel, 44.1/48 kHz, device change, recovery, and 20-minute Windows capture; unknown gaps zero |
